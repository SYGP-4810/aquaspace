        ...
        data.forEach(element => {
            ...
            $.ajax({
                ...
                success: function(data1){
                    ...
                    data1.forEach(el => {
                        if(el.report == 1)
                            reasonsList += "<li>False information</li>";
                        if(el.report == 2)
                            reasonsList += "<li>Illeagal selling</li>";
                        if(el.report == 3)
                            reasonsList += "<li>Shoul not be in aquaspace</li>";
                        if(el.report == 4)
                            reasonsList += "<li>Other</li>";
                    });
                    $("#product-list").append(`
...
$("#unblockAccount").click(function(){   
    ...
    $.ajax({
        ...
        success: function(data){
           ...
           successMsg(["successfully decline the appeal"]);
           delay(function(){
                window.location.replace("/aquaspace/frontend/src/Admin/AdminIssuesUser.html");
           },3000);
